...
class AdminBrandCreatePage extends StatefulWidget {
  const AdminBrandCreatePage({super.key});

  @override
  State<AdminBrandCreatePage> createState() => _AdminBrandCreatePageState();
}

class _AdminBrandCreatePageState extends State<AdminBrandCreatePage> {
  final _formKey = GlobalKey<FormState>();
  final _nameController = TextEditingController();
  final _descriptionController = TextEditingController();
  final _logoUrlController = TextEditingController();
  final _websiteController = TextEditingController();
  final _sustainabilityRatingController = TextEditingController();
  ...
  Future<void> _createBrand() async {
    ...
    try {
      final brandData = {
        ...
        'isSustainable': false, // Default value
        'isPartner': _isPartner,
        'isActive': _isActive,
      };

      final success = await _brandsService.createBrand(brandData);
      if (!success) {
        throw Exception(_brandsService.error ?? 'Unable to create brand');
      }
