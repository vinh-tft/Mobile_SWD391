...
class AdminCategoryEditPage extends StatefulWidget {
  final CategoryResponse category;

  const AdminCategoryEditPage({super.key, required this.category});

  @override
  State<AdminCategoryEditPage> createState() => _AdminCategoryEditPageState();
}

class _AdminCategoryEditPageState extends State<AdminCategoryEditPage> {
  ...
  void initState() {
    ...
    _displayOrderController = TextEditingController(text: widget.category.displayOrder.toString());
  ...
  Future<void> _updateCategory() async {
    ...
    try {
      ...
      final success = await _categoriesService.updateCategory(widget.category.categoryId, categoryData);
      if (!success) {
        throw Exception(_categoriesService.error ?? 'Unable to update category');
      }
            ...
            Consumer<CategoriesService>(
              builder: (context, categoriesService, _) {
                final rootCategories = categoriesService.categories
                    .where((c) => c.isRootCategory && c.categoryId != widget.category.categoryId)
                    .toList();
